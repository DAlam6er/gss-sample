...
public class SampleServer {
  ...
  public static void main(String[] args) throws IOException, GSSException {
    ...
    try (ServerSocket serverSocket = new ServerSocket(LOCAL_PORT)) {
      while (true) {
        ...
        GSSContext gssContext = instantiateContext(manager);
         ...
         * applied to the wrapped token, whether it was
         ...
         * as that used during gssContext establishment.
         */
  ...
  private static void establishSecurityContext(GSSContext context) throws IOException, GSSException {
    /*
     * opaque byte data
